...
public class Scheduling {
  ...
  private static String resultsFile = "/home/darik/university/SPOS/lab3/sched/Summary-Results";
...
//          System.out.println(processnum);
        ...
        if (line.startsWith("process")) {
          ...
          processVector.addElement(new sProcess(cputime, ioblocking, 0, 0, 0, 0, rand.nextInt() % 10));
        }
  ...
  public static void main(String[] arg) {
    ...
    String[] args = {"/home/darik/university/SPOS/lab3/sched/scheduling.conf"};
    ...
    if (processVector.size() < processnum) {
      ...
      while (processVector.size() < processnum) {       
        ...
        processVector.addElement(new sProcess(cputime,i*100,0,0,0, 0, rand.nextInt() % 10));
        i++;
      }
    }
    result = SchedulingAlgorithm.Run(runtime, processVector, result, 3);
    try {
