...
public class PageFault {
  ...
  public static boolean[] workSet = new boolean[64];
  /**
...
//    }
    ...
    if (next_page == -1) {
      next_page = oldest_page;
    }

    Page page = ( Page ) mem.elementAt( next_page );
    Page nextpage = ( Page ) mem.elementAt( replacePageNum );
    controlPanel.removePhysicalPage( next_page );
