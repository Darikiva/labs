package com.lab1.montgomery;

import com.lab1.euclidean.ExtendedEuclidean;
import com.lab1.euclidean.ExtendedEuclideanResult;
...
public class MontgomeryArithmetics {
    ...
    private static BigInteger redc(BigInteger a, BigInteger b, BigInteger n) {
        ...
        BigInteger m = t.multiply(euclideanResult.getBezoutX().negate()).and(r.subtract(BigInteger.ONE));
    ...
    public static BigInteger modMultiply(BigInteger a, BigInteger b, BigInteger mod) {
        ...
        BigInteger uModified = redc(a.shiftLeft(mod.bitLength()).mod(mod), b.shiftLeft(mod.bitLength()).mod(mod), mod);
